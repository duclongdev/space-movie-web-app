        ...
        <div className='pt-12'>
            {
                tabs.map((value, index) => (
                    <button className='flex pt-4 items-center'
                        key={index}
                        onClick={() => setType(value.nameTab)}
                    >
                        <FontAwesomeIcon icon={value.img} className='text-lg dark:text-white'
                            style={
                                type === value.nameTab ?
                                    {
                                        color: "#04DB41"
                        ...
                        />
                        <p className='font-bold text-lg ml-2 dark:text-white'
                            style={
                                type === value.nameTab ?
                                    {
                                        color: "#04DB41"
            ...
            <p className='text-gray-500 text-sm font-bold pt-4 dark:text-gray-300'>Following accounts</p>
            {
                isMore ?
                            ...
                            <div className='ml-4'>
                                <div className='flex'>
                                    <p className='font-bold dark:text-white'>{value.account}</p>
                                    {
                                        value.id % 2 == 0
                                            ?
                                            <FontAwesomeIcon icon={faCircleCheck} className="text-[#00BFFF] ml-1 text-lg" />
                                            :
                                            ""
                                    }
                                </div>
