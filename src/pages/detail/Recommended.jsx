            ...
            <div key={index} className="hover:scale-110 transition-all ease-in duration-300 text-black dark:text-white hover:dark:text-[#00dc5a] hover:text-[#00dc5a] relative item-hover">
              <button className="flex justify-center items-center">
                <img
                  ...
                  className="relative"
                />
                <div className="absolute bottom-[20%] w-full h-[40%] bg-gradient-to-t from-black rounded-b-md"></div>
              </button>
              <button>
              ...
              <p className="absolute text-white bottom-[25%] left-[5%] font-normal text-sm ">{value.title}</p>
              <button>
