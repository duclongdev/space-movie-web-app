      ...
      <div className="grid grid-cols-12 gap-2">
        ...
        >
          ...
          <div className="flex my-6">
            <button
              className="flex px-4 py-2 rounded font-bold items-center justify-center"
              onClick={() => {
                setCurrentPage(1);
                setStatus(1);
              }}
            ...
            >
              ...
              <svg
                ...
                className="ml-2"
              >
                <path d="M13 13v8h6q.825 0 1.413-.587Q21 19.825 21 19v-6Zm0-2h8V5q0-.825-.587-1.413Q19.825 3 19 3h-6Zm-2 0V3H5q-.825 0-1.413.587Q3 4.175 3 5v6Zm0 2H3v6q0 .825.587 1.413Q4.175 21 5 21h6Z" />
              </svg>
            </button>

            <button
              className="flex px-4 py-2 rounded font-bold items-center justify-center ml-4"
              onClick={() => {
                setCurrentPage(2);
                setStatus(2);
              }}
          ...
          {currentPage === 1 ? (
            <MyList callback={setCurrentFilm} data={data} />
          ) : (
            <RankPage callback={setCurrentFilm} />
          )}
          {openModal && (
            <Trailer closeModal={setOpenModal} link={currentFilm.trailer} />
          )}
        </div>
        ...
        <div className="col-span-4 text-white text-base">
          <div className="ml-4 bg-[#171821] h-full relative">
            <img
              className="max-h-[256px] w-full rounded-b-lg"
              src={currentFilm.image}
              alt=""
            />
            <div>
              <div className="pt-4 px-5">
                <h4 className="font-bold text-2xl line-clamp-1">
                  {currentFilm.title}
                </h4>
                ...
                <div className="overflow-y-scroll" style={{ height: "170px" }}>
                  <p className="opacity-70 text-justify text-base mr-2">
                    {currentFilm.content}
                  </p>
                </div>
              </div>
              ...
              <div className="font-semibold absolute bottom-0 w-full">
                ...
                <div className="bg-[#2D2E37] flex font-medium text-black items-center py-3 px-9 justify-between text-base">
                  ...
                  <Link
                    className="rounded-lg py-2 px-8 bg-[#01FF45] flex justify-center items-center font-bold space-x-3 hover:bg-[#4DFF7C]"
                    to="/play"
                  >
                  ...
                  >
                    <FontAwesomeIcon
                      icon={faFilm}
                      className="text-xl"
                      color={openModal ? "#FF9D00" : null}
                    />
                    <p className={openModal ? "text-[#FF9D00] " : null}>
                      Trailer
                    </p>
                  </button>
                </div>
